...
\section{Discussion} \label{sec:discussion}
    ...
    %First of all the spectral index increases much more steeply at the gap cavity, which is a direct consequence of the stronger gradient in the intensity profile with respect to the planetary case.
    ...
    Inside the cavity the spectral index increases again due to the low density and low optical depth of the disc wind.%, which is more pronounced for larger gap cavities.
