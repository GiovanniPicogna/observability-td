...
%\newcommand{\pcm}{\,cm$^{-2}$}	% per cm-square
...
We found that the steepness of the 30 au photoevaporated dust cavity is similar to that of a \SI{1}{M_\mathrm{Jup}} planet (at a similar location), while larger planets and/or larger photoevaporated cavities can generates distinguishable features.
